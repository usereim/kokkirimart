...
public class AdminGoodsDAOImpl  implements AdminGoodsDAO{
	...
	public int insertNewGoods(Map newGoodsMap) throws DataAccessException {
		...
		return Integer.parseInt((String)newGoodsMap.get("product_id"));
	}
	...
	@Override
	public GoodsVO selectGoodsDetail(int product_id) throws DataAccessException{
		GoodsVO goodsBean = new GoodsVO();
		goodsBean=(GoodsVO)sqlSession.selectOne("mapper.admin.goods.selectGoodsDetail",product_id);
		return goodsBean;
	}
	
	@Override
	public List selectGoodsImageFileList(int product_id) throws DataAccessException {
		List imageList=new ArrayList();
		imageList=(List)sqlSession.selectList("mapper.admin.goods.selectGoodsImageFileList",product_id);
		return imageList;
	}
	...
	@Override
	public void deleteGoods(int product_id) throws DataAccessException{
		sqlSession.delete("mapper.admin.goods.deleteGoods",product_id);
	}
