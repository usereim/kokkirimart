...
public interface MyPageController {
	...
	public ModelAndView showConsultationPage(@RequestParam("member_id") String member_Id,
			@RequestParam("product_name") String product_Name, @RequestParam("order_id") String order_Id, HttpServletRequest request, HttpServletResponse response) throws Exception;
