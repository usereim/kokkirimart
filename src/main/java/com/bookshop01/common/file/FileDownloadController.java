...
public class FileDownloadController {
	...
	private static String IMAGE_PATH = "C:\\board\\article_image1";
	...
	protected void downloadNoticeImage(@RequestParam("fileName") String fileName,
		                 	@RequestParam("notice_No") int notice_No,
			                 HttpServletResponse response) throws Exception {
		OutputStream out = response.getOutputStream();
		String filePath=IMAGE_PATH+"\\"+notice_No+"\\"+fileName;
	...
	@RequestMapping("/noticedown.do")
	protected void noticedown(@RequestParam("notice_No") String notice_No,
		                 	@RequestParam("image_Name") String image_Name,
			                 HttpServletResponse response) throws Exception {
		OutputStream out = response.getOutputStream();
		String filePath=IMAGE_PATH+"\\"+notice_No+"\\"+image_Name;
		File image=new File(filePath);
