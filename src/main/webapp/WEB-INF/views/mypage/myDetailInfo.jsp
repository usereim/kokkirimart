        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                if(data.autoRoadAddress) {
                    ...
                    var expdetailAddr = data.autodetailAddress;
                    document.getElementById('guide').innerHTML = '(예상 지번 주소 : ' + expdetailAddr + ')';
...
function fn_modify_member_info(attribute){
	...
	// alert("mod_type:"+mod_type);
		...
		if(attribute=='member_pw'){
			...
			value=value_zipcode+","+value_roadAddress+","+value_detailAddress;
		}
		...
		$.ajax({
			...
			error : function(data, textStatus) {
				...
				console.log(frmModMember.memberBirthY.value);
				console.log(frmModMember.memberBirthM.value);
				console.log(frmModMember.memberBirthD.value);
			},
					...
					<tr class="dot_line">
						...
						<td><input type="text" id="zipcode" name="zipcode" size=5
							...
							<p>
								...
								<br> 상세 주소: <input type="text" id="detailAddress"
									name="detailAddress" size="50"
									value="${memberInfo.detailAddress }"><br> <br>
