...
<script type="text/javascript">
  ...
  function backToList(obj){
    obj.action="${contextPath}/article/listArticles.do";
    obj.submit();
  }
...
<h1 style="text-align:center">답글쓰기</h1>
  <form name="replyArticleForm" method="post"   action="${contextPath}/article/addReplyArticle.do"   enctype="multipart/form-data">
    <table border="0"  align="center">
     ...
     <tr>
			  ...
			  <td><img  id="preview0" src="#"   width=640px height=480px height="500" width="500" /></td>
	   </tr>
